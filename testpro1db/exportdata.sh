...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/BRZBZVZK6L99JWHQEZ6HPW/AB02E856-465D-4C39-B500-98FFD83FF15C/art/data
AST_DATA_PATH=/tmp/applifire/db/BRZBZVZK6L99JWHQEZ6HPW/AB02E856-465D-4C39-B500-98FFD83FF15C/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
HOST=localhost
MYSQL=/usr/bin
PROJECT_ID=BRZBZVZK6L99JWHQEZ6HPW
