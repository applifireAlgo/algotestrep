Ext.define('Testpro1.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Testpro1.view.reportui.datachart.chart.RatingField','Testpro1.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
