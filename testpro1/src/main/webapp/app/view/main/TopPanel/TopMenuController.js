...
Ext.define('Testpro1.view.main.TopPanel.TopMenuController', {
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								if(menu.config.data.uiType && menu.config.data.uiType=='M')
 								{
 	 									...
 	 									var component = Ext.create('Testpro1.view.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});
