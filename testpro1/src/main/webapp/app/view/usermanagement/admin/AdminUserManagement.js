Ext.define('Testpro1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Testpro1.view.usermanagement.admin.UserPasswordReset',
	            'Testpro1.view.usermanagement.admin.AddUserDetails',
	            'Testpro1.view.usermanagement.admin.ViewUser'],
