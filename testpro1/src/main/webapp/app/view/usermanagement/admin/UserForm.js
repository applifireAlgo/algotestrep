Ext.define('Testpro1.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Testpro1.view.usermanagement.admin.AddUserDetailsViewModel', 'Testpro1.model.AddUserDataModel' ],
