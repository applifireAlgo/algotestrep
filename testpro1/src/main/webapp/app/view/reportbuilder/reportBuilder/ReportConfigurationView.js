Ext.define('Testpro1.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Testpro1.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Testpro1.view.reportbuilder.gridconfig.GridConfigView',
	           'Testpro1.view.reportbuilder.properties.PropertiesPanelView',
	           'Testpro1.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
