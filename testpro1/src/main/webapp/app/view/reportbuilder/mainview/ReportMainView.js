Ext.define('Testpro1.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Testpro1.view.reportbuilder.reportlist.ReportListPanelView',
             'Testpro1.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Testpro1.view.reportbuilder.mainview.ReportMainController'
             ],
