Ext.define('Testpro1.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Testpro1.view.reportbuilder.properties.RptDataEndPointGridController'],
