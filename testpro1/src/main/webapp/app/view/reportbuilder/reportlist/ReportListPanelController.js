Ext.define('Testpro1.view.reportbuilder.reportlist.ReportListPanelController',{
	    	...
	    	Ext.Ajax.request(
	    	{
	    		...
	    		success:function(response, currentObject,options) 
	    		{
	    			...
	    			if (responseJson.response.success == 'true') 
	    			{
			    		...
			    		var tab=Ext.create('Testpro1.view.reportbuilder.reportBuilder.ReportBuilderView', //activeTab
			    		{
			    			closable:true,
			    			iconCls:'editTabIcon',
