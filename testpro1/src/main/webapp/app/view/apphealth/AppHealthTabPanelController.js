 ...
 * 
 */
Ext.define('Testpro1.view.apphealth.AppHealthTabPanelController',{
	extend : 'Ext.app.ViewController',
	alias : 'controller.appHealthTabPanelController',
	requires : ['Testpro1.view.apphealth.AppHealthConnector'],
						...
						success : function(response, opts){
							...
							if (responseJson.response.success) {
								...
								for(var i = 0; i < appHealthSchedulerData.length; i++)
								{
									...
									var connectorPanel = Ext.create("Testpro1.view.apphealth.AppHealthConnector", {
