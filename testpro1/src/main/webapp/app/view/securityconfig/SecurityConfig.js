 ...
 * 
 */
Ext.define('Testpro1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Testpro1.view.securityconfig.SecurityConfigController',
			'Testpro1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
