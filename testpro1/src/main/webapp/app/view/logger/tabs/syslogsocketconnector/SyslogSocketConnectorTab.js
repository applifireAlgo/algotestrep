 ...
 * 
 */
Ext.define('Testpro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Testpro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
