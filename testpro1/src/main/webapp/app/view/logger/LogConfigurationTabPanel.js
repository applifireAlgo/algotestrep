...
Ext
		.define(
				'Testpro1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Testpro1.view.logger.tabs.details.DetailsTab',
							'Testpro1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Testpro1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Testpro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Testpro1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Testpro1.view.logger.LogConfigurationTabPanelController',
