Ext.define('Testpro1.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testpro1.view.querybuildernewmodel.querycondition.QuerySelectController',
