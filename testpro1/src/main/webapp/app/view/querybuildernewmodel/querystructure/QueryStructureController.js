Ext.define('Testpro1.view.querybuildernewmodel.querystructure.QueryStructureController', {
	...
	init:function(){
		...
		this.queryStructreStore = Ext.create('Testpro1.view.querybuildernewmodel.querystructure.QueryStructureStore');
	...
	afterrender :function( tree,eOpts ){
		...
		var rootChildNodes = root.childNodes;
				...
				for (var q = 0; q < rootChildNodes.length; q++) {
					...
					var model = Ext.create('Testpro1.view.querybuildernewmodel.querystructure.QueryStructureModel');
