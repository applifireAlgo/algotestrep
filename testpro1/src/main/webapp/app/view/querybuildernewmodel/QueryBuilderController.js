Ext.define('Testpro1.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Testpro1.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Testpro1.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Testpro1.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Testpro1.view.querybuildernewmodel.querydetail.QueryDetail');
