Ext.define('Testpro1.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Testpro1.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
