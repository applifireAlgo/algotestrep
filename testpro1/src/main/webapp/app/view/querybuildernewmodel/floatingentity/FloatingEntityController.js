Ext.define('Testpro1.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Testpro1.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Testpro1.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Testpro1.view.querybuildernewmodel.floatingentity.EntitySprite',
