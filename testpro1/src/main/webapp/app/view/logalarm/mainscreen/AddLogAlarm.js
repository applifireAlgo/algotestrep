 ...
 * 
 */
Ext.define('Testpro1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Testpro1.view.logalarm.mainscreen.AddLogAlarmController',
			'Testpro1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Testpro1.view.logalarm.mainscreen.AppAlarmPanel',
