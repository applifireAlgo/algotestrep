 ...
 * 
 */
Ext.define('Testpro1.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Testpro1.view.logalarm.LogAlarmMainViewController',
			'Testpro1.view.logalarm.tree.LogAlarmTreePanel',
			'Testpro1.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
