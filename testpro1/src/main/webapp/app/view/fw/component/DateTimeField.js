 ...
 */
Ext.define('Testpro1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Testpro1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Testpro1.view.fw.component.DateTimePicker(o);
    },
