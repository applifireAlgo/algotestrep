Ext.define('Testpro1.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Testpro1.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Testpro1.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
