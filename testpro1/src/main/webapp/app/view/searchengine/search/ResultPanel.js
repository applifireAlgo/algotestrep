Ext
		.define(
				'Testpro1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Testpro1.view.searchengine.search.SearchEngineMainPanelController','Testpro1.view.searchengine.search.PanelHeaderField' ,'Testpro1.view.searchengine.search.ReportGridView','Testpro1.view.searchengine.search.ReportChartView','Testpro1.view.searchengine.search.documentView','Testpro1.view.searchengine.search.DouMeanView','Testpro1.view.googlemaps.map.MapPanel'],
