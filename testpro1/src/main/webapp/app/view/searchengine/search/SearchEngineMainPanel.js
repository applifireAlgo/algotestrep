Ext.define('Testpro1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Testpro1.view.searchengine.search.NorthPanel', 'Testpro1.view.searchengine.search.SearchResult','Testpro1.view.searchengine.search.SearchEngineMainPanelController'],
