...
@SourceCodeAuthorClass(createdBy = "zeelthakkar@gmail.com", updatedBy = "", versionNumber = "1", comments = "Service for ContactType Master table Entity", complexity = Complexity.LOW)
