...
import com.app.server.repository.ClassroomRepository;
...
@SourceCodeAuthorClass(createdBy = "zeelthakkar@gmail.com", updatedBy = "", versionNumber = "1", comments = "Service for Classroom Master table Entity", complexity = Complexity.LOW)
@RequestMapping("/Classroom")
public class ClassroomServiceImpl extends ClassroomService {
    ...
    @Autowired
    private ClassroomRepository<Classroom> classroomrepo;
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.defaultdomain.Classroom> lstclassroom = classroomrepo.findAll();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstclassroom);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    }

    @RequestMapping(consumes = "application/json", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody Classroom entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<Classroom> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            classroomrepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody Classroom entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            classroomrepo.update(entity);
            responseBean.add("success", true);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<Classroom> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            classroomrepo.update(entity);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.defaultdomain.Classroom lstclassroom = classroomrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstclassroom);
        } catch (org.springframework.transaction.TransactionException e) {
