...
@SourceCodeAuthorClass(createdBy = "zeelthakkar@gmail.com", updatedBy = "", versionNumber = "1", comments = "Repository for AppCustomerType Master table Entity", complexity = Complexity.LOW)
